...
public interface IMqConstants
{
  ...
  static public final String cKasPropertyQueryGroupName    = cKasPropertyPrefix + "qry.grp.name";
  static public final String cKasPropertyQueryUserName     = cKasPropertyPrefix + "qry.usr.name";
  static public final String cKasPropertyQueryQueueName    = cKasPropertyPrefix + "qry.q.name";
  static public final String cKasPropertyQueryAllData      = cKasPropertyPrefix + "qry.q.alldata";
  static public final String cKasPropertyQueryFormatOutput = cKasPropertyPrefix + "qry.q.format";
  static public final String cKasPropertyQueryConnId       = cKasPropertyPrefix + "qry.conn.id";
  static public final String cKasPropertyQuerySessId       = cKasPropertyPrefix + "qry.sess.id";
