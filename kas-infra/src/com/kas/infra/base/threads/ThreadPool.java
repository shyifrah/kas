...
public class ThreadPool
{
  ...
  /**
   * Schedule a {@link Callable} object for repeated execution
   * 
   * @param command A {@link Callable} object to execute
   * @param initDelay The number of time-units to delay the {@link Callable} execution
   * @param period The number of time-units to delay the {@link Callable} subsequent executions
