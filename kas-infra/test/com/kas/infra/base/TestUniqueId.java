...
public class TestUniqueId
{
  static public void main(String [] args)
  {
    ...
    oTest.add("hashCode", allZeroes.hashCode());
    oTest.add("compareTo", 0, allZeroes);
    oTest.run();
    ...
    UniqueId fromString = UniqueId.fromString(strUuid);
    
    oTest = new ObjectTest(copyOfRandomUuid);
    oTest.add("getUuid", randomUuid);
    oTest.add("read", randomUuid);          // method does not exist
    ...
    strUuid    = "01020304-0506-0708-0900-0a0b0c0d0e0f";
    UniqueId fromByteArray = UniqueId.fromByteArray(byteArrayUuid);
    fromString = UniqueId.fromString(strUuid);
    
    oTest = new ObjectTest(fromByteArray);
    oTest.add("toString", strUuid);
    oTest.add("equals", true, fromString);
    oTest.add("hashCode", fromString.hashCode());
    oTest.add("compareTo", 0, fromString);
    oTest.run();
  }
}
