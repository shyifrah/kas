...
public class TestUniqueId
{
  static public void main(String [] args)
  {
    ...
    set = new ObjectTest(copyOfAllZeroes);
    set.add("equals", true, allZeroes);
    set.add("toString", "00000000-0000-0000-0000-000000000000");
    set.run();
    ...
    set = new ObjectTest(copyOfRandomUuid);
    set.add("getUuid", randomUuid);
    set.run();
    ...
    set = new ObjectTest(fromByteArray);
    set.add("toString", stringUuid);
    set.add("equals", true, fromString);
    set.run();
  }
}
